...
; Replace with your application code
    ...
    OUT Digits_P,R20
  MainLoop:                  
    SET_DIGIT 0         //ZAPALENIE WYSWIETLACZA 0 I CYFRY DO NIEGO PRZYPISANEJ
    SET_DIGIT 1         //ZAPALENIE WYSWIETLACZA 1 I CYFRY DO NIEGO PRZYPISANEJ
    SET_DIGIT 2         //ZAPALENIE WYSWIETLACZA 2 I CYFRY DO NIEGO PRZYPISANEJ
